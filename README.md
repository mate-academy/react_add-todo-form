...
1. Creagit te an `App` component storing the `todos` array and displaying it using the `TodoList`.
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://ivangrabovsky.github.io/react_add-todo-form/) and add it to the PR description.
