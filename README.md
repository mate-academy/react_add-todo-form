...
1. Add validation to the form:
    - add
    - a default empty option `Choose a user` to the select;
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Serhii-vovk.github.io/react_add-todo-form/) and add it to the PR description.
